  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="custom-control custom-radio custom-control-inline">
        <input name="gender" id="jk_0" type="radio" class="custom-control-input" value="P"> 
        <label for="jk_0" class="custom-control-label">Perempuan</label>
      </div>
      <div class="custom-control custom-radio custom-control-inline">
        <input name="gender" id="jk_1" type="radio" class="custom-control-input" value="L"> 
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="prodi_kode" name="prodi_kode" type="text" class="form-control">
      </div>
    </div>
  </div>
